...
const paymentOptions = [
  {
    ...
    logo: (
      <img
        ...
        alt="Logo"
        className="w-10 sm:w-14 mx-auto"
      />
    ),
  },
  {
...
const PassengerPayment = () => {
  ...
  return (
    <div className="my-4 grid grid-cols-1 sm:grid-cols-2 gap-8 border rounded-lg p-4">
      ...
      <div className="sm:border rounded-lg sm:p-4 relative">
        <h2 className="text-xl text-center mt-4 font-semibold">Fees</h2>
        <div className="mt-3 flex-center-between">
          <h1>Transport Fare</h1>
          <h1 className="text-muted font-medium">Ugx. 45,000</h1>
        </div>
        <div className="mt-3 flex-center-between">
          <h1>Services Fee</h1>
          <h1 className="text-muted font-medium">Ugx. 2000</h1>
        </div>
        <div className="mt-3 flex-center-between">
          <h1>Total</h1>
          <h1 className="font-medium text-xl text-primary">Shs. 47,000</h1>
        </div>
        <div className="flex-center-center sm:flex-none">
          <button className="sm:absolute sm:bottom-3 sm:left-1/2 sm:-translate-x-1/2 btn btn-secondary mt-4 sm:mt-3">
            Make Payment Now
          </button>
        </div>
      </div>
